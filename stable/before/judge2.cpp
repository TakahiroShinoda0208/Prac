...
void judge_close(ifstream &fin0,ifstream &fin1,double &x1,double &x2,double &x3,double &x4);
void judge_open(ifstream &fin0,ifstream &fin1,double &x1,double &x2,double &x3,double &x4);
...
//入力ファイルが存在しなかった時の出力
      ...
      case 0:
            judge_close(fin0,fin1,x025,x250,x750,x975);
            break;
            
      case 1:
            judge_open(fin0,fin1,x025,x250,x750,x975);
            break;
      default :
            cout <<"flag doesnt work well in closing and opeing point" <<endl;
            return 1;
            break;
      }
